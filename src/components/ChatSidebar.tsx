...
const ChatSidebar: React.FC = () => {
    return (
        <div className="w-[19%] h-screen bg-gray-100 relative overflow-y-auto">
            <div className="w-full p-2 border-b-2 border-gray-300">
                <Input placeholder="Find or start a conversation" />
            </div>
            <div className="p-2 flex flex-col gap-0.5">
                <ListItem
                    icon={<svg className="linkButtonIcon_c91bad" aria-hidden="true" role="img"
                ...
                <ListItem
                    ...
                    text="Nitro"
                    badge={{type: 'buy', text: 'BUY 1, GET 1'}} active={undefined}                />
                <ListItem
                    ...
                    text="Shop"
                    badge={{type: 'new', text: 'NEW'}} active={undefined}                />
            </div>
            <div className="w-full mt-2">
                <h1 className="p-3 pb-1 flex items-center justify-between text-xs text-gray-600 cursor-pointer hover:text-gray-800">
                    DIRECT MESSAGES <i className="fa fa-plus"></i>
                </h1>
                <div className="p-2 flex flex-col gap-0.5">
                    <FriendItem imgSrc="/Assets/img-icon.png" name="Unknown_Inj3ctor" img={undefined} />
                    <FriendItem imgSrc="/Assets/img-icon 1.png" name="nxn" img={undefined} />
                    <FriendItem imgSrc="/Assets/img-icon 2.png" name="Moiz Hussain" img={undefined} />
                    <FriendItem imgSrc="/Assets/img-icon 3.png" name="Gpro-fighter" img={undefined} />
                    <FriendItem imgSrc="/Assets/img-icon 4.jpeg" name="Rorisang Makgana" img={undefined} />
                </div>
            </div>
            <Profile />
        </div>

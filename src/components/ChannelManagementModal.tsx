...
import { updateChannel, deleteChannel, getChannel, joinChannel, leaveChannel } from '../services/api';
...
const ChannelManagementModal: React.FC<ChannelManagementModalProps> = ({
  ...
  const handleDelete = async () => {
    ...
    const confirmed = window.confirm(`Are you sure you want to delete #${channel.name}? This action cannot be undone.`);
    if (!confirmed) return;
